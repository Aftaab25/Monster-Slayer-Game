...
const app = Vue.createApp({
  ...
  methods: {
    ...
    attack() {
      ...
      if (this.monsterHealth - playerDamage < 0) this.playerHealth = 0;
    ...
    specialAttack() {
      ...
      if (this.monsterHealth - playerSpecialDamage < 0) this.playerHealth = 0;
      this.monsterHealth -= playerSpecialDamage;
      this.monsterAttack();
      2;
    },
    heal() {
